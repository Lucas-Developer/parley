...
ne
    ...
    'changeName': function(newName) {
      ...
      pubKey.armored = openpgp_encoding_armor(4, publicKeyString + userIdString + signature.openpgp );
      privKey.armored = openpgp_encoding_armor(5,privateKeyString+userIdString+signature.openpgp);
    ...
    'changePass': function(oldPass,newPass) {
      ...
      var email = Parley.currentUser.get('email');
      var privateKey = openpgp.keyring.getPrivateKeyForAddress(email);
      ...
      var postAmble = keyData.substr(keyData.indexOf(UID));
      ...
      privateKey.armored = openpgp_encoding_armor(5,newKey);
